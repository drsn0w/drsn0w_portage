...
SRC_URI="https://github.com/DSheirer/sdrtrunk/releases/download/v0.5.0-alpha.6/sdr-trunk-linux-x86_64-v0.5.0-alpha6.zip"
...
S="${WORKDIR}/sdr-trunk-linux-x86_64-v0.5.0-alpha6"
